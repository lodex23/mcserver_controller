                ...
                try
                {
                    ...
                    while (true)
                    {
                        ...
                        if(data.IndexOf("<start>")> -1)
                        {
                            ...
                            //Start mcServer
                            Process mcbedrock = new Process();
                            mcbedrock.StartInfo.FileName = "C:\\Users\\jeffr\\Documents\\C#_Projecten\\Socket\\Socket_Server\\bedrock.txt";
                            mcbedrock.Start();
                            Console.ReadLine();



                            byte[] msg = Encoding.ASCII.GetBytes("msg: True, Recieved");
                            handler.Send(msg);
                        ...
                        if(data.IndexOf("<reboot>")> -1)
                        {
                            ...
                            byte[] msg = Encoding.ASCII.GetBytes("msg: restart, Recieved");
                            handler.Send(msg);
